...
const Hero = () => {
  return (
    ...
    viewport={{once: true}}
    id='home'
    className='min-h-screen flex items-center pt-20 pb-16 bg-linear-to-r from-dark-100
    via-dark-300 to-dark-100'
    >
...
<h1 className='text-4xl md:text-6xl font-bold mb-4'>
    Hi, I'm <span className='text-purple'>Abosede Soyinka</span></h1>
<h2
 className='text-2xl md:text-4xl font-semibold mb-6 typewriter'>Frontend Developer</h2>
...
bg-linear-to-r from-purple to-pink opacity-70">
   ...
   src={assets.myimage1} alt="profileImg" /> 
</div>
</div>
